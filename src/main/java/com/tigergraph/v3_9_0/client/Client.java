 ...
 * ****************************************************************************
 */
package com.tigergraph.v3_9_0.client;

import com.tigergraph.v3_9_0.client.util.*;
import com.tigergraph.v3_9_0.client.util.SystemUtils.ExitStatus;
...
import com.tigergraph.v3_9_0.client.logging.GsqlClientLogger;
import static com.tigergraph.v3_9_0.client.util.SystemUtils.logger;
...
public class Client {
  ...
  private String generateCookies() {
    ...
    cookieJSON.put("gShellTest", gShellTest != null && !gShellTest.isEmpty());
  ...
  if (true) return "d237376de0898a3c958e3622c0a426305c0da314"; String clientCommitHash = null;
    try {
