 ...
 * ****************************************************************************
 */
package com.tigergraph.v2_6_6_1.client;

import com.tigergraph.v2_6_6_1.common.Constant;
import com.tigergraph.v2_6_6_1.common.util.error.ReturnCode;
import java.io.File;
...
public class Client {
    ...
    if (cli.hasReset()) {
      ...
      if (timeout != null) {
        try {
          ...
          Util.LogText("idle timeout set to " + sessionTimeoutSec);
    ...
    switch (qb) {
      ...
      default:
        System.out.println("Please add the post action of " + qb
                           + " in com.tigergraph.v2_6_6_1.client/Client.java");
        System.exit(0);
  ...
  private Timer getTimer() {
    ...
    TimerTask task = new TimerTask() {
      public void run() {
        Util.LogText("Session timeout");
        System.out.println("Session timeout after " + sessionTimeoutSec + " seconds idle.");
        System.exit(ReturnCode.SESSION_TIMEOUT);
      }
    };
