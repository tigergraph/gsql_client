 ...
 * ****************************************************************************
 */
package com.tigergraph.v3_0_5_1.client;

import static com.tigergraph.v3_0_5_1.client.util.SystemUtils.ExitStatus;
import static com.tigergraph.v3_0_5_1.client.util.SystemUtils.logger;

import com.tigergraph.v3_0_5_1.client.util.*;
...
public class Client {
  ...
  public JSONObject executeAuth(String endpoint) {
    ...
    try {
      ...
      // open connection
      conn = createConnection(endpoint, msg, true, "POST");
  ...
  public String getInfo(String endpoint, String msg) {
    ...
    sendHttpRequest(endpoint, msg, "GET", response -> {
   ...
   */
  private boolean sendHttpRequest(String endpoint, String data,
      String method, HttpReponseOperator op) {
    HttpURLConnection conn = null;
    try {
      // open connection
      conn = createConnection(endpoint, data, false, method);
  ...
  public void sendPost(String endpoint, String msg) {
    sendHttpRequest(endpoint, msg, "POST", null);
  }
  ...
  public void executePost(String endpoint, String msg) {
    HttpReponseOperator op = response -> {
      // print out response
      Scanner sc = new Scanner(response);
      String line;
    ...
    sendHttpRequest(endpoint, msg, "POST", op);
  }
  ...
  public void dialogBox(String input) {
    ...
    switch (qb) {
      ...
      case "PutFileQb": {
        ...
        if (!sendHttpRequest(ENDPOINT_UDF + "?filename=" + filename,
        ...
        if (!sendHttpRequest(ENDPOINT_UDF + "?filename=" + filename,
            null, "GET", response -> {
              ...
              if (json.getBoolean("error")) {
                ...
                IOUtils.get().writeToFile(path, json.getString("result"));
  ...
  private HttpURLConnection createConnection(String endpoint, String msg, boolean isLogin,
      String method) throws ConnectException {
    try {
      ...
      return retryableHttpConn.connect(endpoint, method, msg, headers);
    } catch (Exception e) {
  ...
  if (true) return "4201b10cc145c2eb5f4e008e8ee5be7f228ded69"; String clientCommitHash = null;
    try {
