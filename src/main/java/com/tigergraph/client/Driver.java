...
public class Driver {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 2; i++) {
            ...
            if ( i==1 ) {
                Supported_Versions = Supported_Versions + "v3_9_3 ";
            }
            if ( ( i==1 && Gsql_Client_Version.equalsIgnoreCase("v3_9_3") ) ||
                 ( i==2 && (!Gsql_Client_Version.equalsIgnoreCase("v3_9_3")) )){
                try {
                    System.out.println("========================");
                    System.out.println("Trying version: v3_9_3");
                    com.tigergraph.v3_9_3.client.Driver.main(args);
