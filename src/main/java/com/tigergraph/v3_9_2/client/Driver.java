...
import static com.tigergraph.v3_9_2.client.util.SystemUtils.ExitStatus;
import static com.tigergraph.v3_9_2.client.util.SystemUtils.logger;

import com.tigergraph.v3_9_2.client.util.RetryableHttpConnection;
...
public class Driver {
  ...
  public static void main(String[] args) {
    ...
    try {
      conn = new RetryableHttpConnection(serverPort);
      ...
      // set SSLContext after add ips
      conn.setSslContext(cli.hasCacert() || cli.hasSsl(), cli.getCacert());
